...
int main(int argc, char *argv[]) {
	...
	std::unordered_map<std::string, Colour> materials = loadMtlFile("models/cornell-box.mtl");

	std::vector<ModelTriangle> faces = loadObjFile("models/cornell-box.obj", vertexScale, materials);
